...
/**
 * @param {string} content
 * @param {Array<string|{name: string, separator: string, start: string, end: string, prefix: string, suffix: string, replacement?: string}>} blockOptions
 *
 * @return {string}
 */
...
/**
 * @param {string|{name: string, separator: string, start: string, end: string, prefix: string, suffix: string, replacement?: string}} option
 *
 * @return {{start: string, end: string, prefix: string, suffix: string, replacement?: string}}
 */
