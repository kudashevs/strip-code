...
function generateBlock(option) {
  if (typeof option === 'object') {
    return generateBlockFromObject(option);
  }
...
/**
 * @param {{name: string, separator?: string, prefix?: string, suffix?: string, replacement?: string}|{start: string, end: string, prefix?: string, suffix?: string, replacement?: string}} values
 *
 * @return {{start: string, end: string, prefix: string, suffix: string, replacement?: string}}
 */
